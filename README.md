\[Факт] Привожу пример подробного README-документа для командной разработки и эксплуатации, с учётом всех описанных сценариев работы с багами в продакшене, hotfix, откатом и maintenance mode.
